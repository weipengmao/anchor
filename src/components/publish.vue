<template>
<div class="clearfix" id="publish">
    <div class="publish-top clearfix">
        <img src="../img/publish/publish-arrow.png" alt="">
        <p class="publish-button">发布通告</p>
        <p class="publish-button">通告列表</p>
    </div>
    <!-- 表单 -->
    <div class="publish-form">
    <form action="#">
        <input type="text" placeholder="*名称">
        <input type="text" placeholder="*介绍">
        <input type="text" placeholder="*时间">
        <input type="text" placeholder="*地点">
        <input type="text" placeholder="*主办单位">
        <!-- 上传图片 -->
        <p class="publish-topic">*上传图片</p>
                <!--    照片添加    -->
        <div class="z_photo">
            <div class="z_file">
